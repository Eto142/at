                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-dark">
                            <h3 class="mb-2 d-inline text-light">Add New payment Method</h3>
                            ...
                            <div>
                                <form method="POST" action="{{route('add.payment')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control bg-dark text-light" name="name" id="name" placeholder="Payment method name" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6 class="text-light">Minimum Amount</h6>
                                            <input type="number" class="form-control bg-dark text-light" name="min_amount" id="minamount" required>
                                            <small class="text-light">Required but only applies to withdrawal</small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6 class="text-light">Maximum Amount</h6>
                                            <input type="number" class="form-control bg-dark text-light" name="max_amount" id="maxamount" required>
                                            <small class="text-light">Required but only applies to withdrawal</small>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6 class="text-light">Charges</h6>
                                            <input type="number" class="form-control bg-dark text-light" name="charges" id="charges" required>
                                            <small class="text-light">Required but only applies to withdrawal</small>
                                        </div>
                                        <div class="form-group col-md-6">
                                       ...
                                       <!-- <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6 currency">
                                            ...
                                            <input type="text" class="form-control bg-dark text-light currinput" name="bank_name" id="bank">
                                        </div>
                                        <div class="form-group col-md-6 currency">
                                            <h6 class="text-light">Account Name</h6>
                                            <input type="text" class="form-control bg-dark text-light currinput" name="account_name" id="acnt_name">
                                        </div>
                                        <div class="form-group col-md-6 currency">
                                            <h6 class="text-light">Account Number</h6>
                                            <input type="number" class="form-control bg-dark text-light currinput" name="account_number" id="acnt_number">
                                        </div>
                                        <div class="form-group col-md-6 currency">
                                            <h6 class="text-light">Swift/Other Code</h6>
                                            <input type="text" class="form-control bg-dark text-light currinput" name="code" id="swift">
                                        </div>

                                        
                                        <div class="form-group col-md-6 d-none crypto">
                                            <h6 class="text-light">Wallet Address</h6>
                                            <input type="text" class="form-control bg-dark text-light cryptoinput" name="wallet_address" id="walletaddress">
                                        </div>
                                        <div class="form-group col-md-6 d-none crypto">
                                            <h6 class="text-light">Wallet Address Network Type</h6>
                                            <input type="text" placeholder="eg ERC" class="form-control bg-dark text-light cryptoinput" name="wallet_type" id="wallettype">
                                        </div>
                                        <div class="form-group col-md-6 d-none crypto">
                                            <h6 class="text-light">Gateway Icon</h6>
                                            <input type="file" name="icon" id=""  class="form-control bg-dark text-light cryptoinput">
                                            <small class="text-light">Recommended Size: 575px both width and height </small>
                                            
                                        </div>
                                        <div class="form-group col-md-6 d-none crypto">
                                            <h6 class="text-light">Barcode Image (QR-CODE)</h6>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control bg-dark text-light" name="note" placeholder="Payment may take up to 24 hours">
                                        </div>
                                        <div class="form-group col-md-12">
            ...
            <table class="table table-hover">
               ...
               @foreach($payment as $payment)
                <tr>
                            ...
                            <td>
                            <a href="{{route('edit.payment',$payment->id)}}" class="m-1 btn btn-primary btn-sm" title="View">
                                <i class="fa fa-eye"></i>
                            </a>
                           ...
                           @else
                            <a href="{{route('delete.payment',$payment->id)}}" class="m-1 btn btn-danger btn-sm">Delete</a> 
...
<script>
    ...
    <div class="col-md-12">
        <form action="javascript:void(0)" method="POST" id="paypreform">
            <input type="hidden" name="_token" value="vhWnzQofgzZnJJak3rZhWzGpW0aKJX7T7MJuTqHi">            <input type="hidden" name="_method" value="PUT">            <div class="form-row">
                <div class="form-group col-md-6">
                    <h5 class="text-light"> Deposit option:</h5>
                    <select name="deposit_option" class="form-control bg-dark text-light">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="withdrawal_option" class="form-control bg-dark text-light">
                        <option value="manual">manual(Current)</option>
                        <option value="manual">Manual</option>
                        <option  value="auto">Automatic</option>
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control text-light bg-dark"  type="text" name="minamt" value="500" required> 
                    <small class="text-light">This amount indicates the minimum amount a user can deposit</small>
                </div> 
                <div class="form-group col-md-12">
    ...
    <div class="col-md-8 offset-md-2">
        <form action="javascript:void(0)" method="POST" id="coinpayform">
            <input type="hidden" name="_token" value="vhWnzQofgzZnJJak3rZhWzGpW0aKJX7T7MJuTqHi">            <input type="hidden" name="_method" value="PUT">            <div class="form-group">
                <h5 class="text-light">Merchant ID</h5>
                <input  class="form-control text-light bg-dark" placeholder="Merchant ID" type="text" name="cp_m_id" value="Merchid ID" required> 
            </div>
            
            <div class="form-group">
                <h5 class="text-light">CoinPayment IPN Secret</h5>
                <input class="form-control text-light bg-dark" placeholder="CoinPayment IPN Secret" type="text" name="cp_ipn_secret" value="jnndjnhdjdj" required> 
            </div>
            
            <div class="form-group">
                <h5 class="text-light">CoinPayments debug email</h5>
                <input class="form-control text-light bg-dark" placeholder="CoinPayments debug email" type="text" name="cp_debug_email" value="super@happ.com" required> 
            </div>
            <div class="form-group">
                <h5 class="text-light">Public key</h5>
                <input class="form-control text-light bg-dark" placeholder="Public key" type="text" name="cp_p_key" value="TYooMQauvdEDq54NiTphI7jx" required> 
            </div>
            <div class="form-group">
                <h5 class="text-light">Private key</h5>
                <input class="form-control text-light bg-dark" placeholder="Private key" type="text" name="cp_pv_key" value="4eC39HqLyjWDarjtT1zdp7dc" required>
            </div>
            <div class="form-group">
    ...
    <div class="col-md-12">
        <form action="javascript:void(0)" method="POST" id="gatewayform">
            <input type="hidden" name="_token" value="vhWnzQofgzZnJJak3rZhWzGpW0aKJX7T7MJuTqHi">            <input type="hidden" name="_method" value="PUT">            <h4 class="text-primary"> <i class="fa fab-stripe"></i> Stripe:</h4>
            <div class="form-group">
                <h5 class="text-light">Stripe secret key</h5>
                <input type="text" name="s_s_k" class="form-control bg-dark text-light" value="sk_test_51JP8qpSBWKZBQRLPWqHkFM8oqFEAqXLAaH3S8byZF73X0UycxijVyfebcyu6OVoZ8eeAelr3js3ADYIGU22Dk2Vo00kGkdE9xP">
            </div>
            <div class="form-group">
                <h5 class="text-light">Stripe publishable key</h5>
                <input type="text" name="s_p_k" class="form-control bg-dark text-light" value="pk_test_51JP8qpSBWKZBQRLPUIfQVYfUGly65fb1LiPUwAUajKy1nVM9Rvly3v3hQLvXnRqrWCrnUNz1qPQHNSxE689tSAoL00B1iOTNfd">
            </div>
            <hr>
            <h4 class="text-primary"><i class="fa fab-paypal"></i> Paypal:</h4>
            <div class="form-group">
                <h4 class="text-light">Paypal client ID</h4>
                <input type="text" name="pp_ci" class="form-control bg-dark text-light" value="iidjdjdj">
            </div>
            <div class="form-group">
                <h4 class="text-light">Paypal client secret</h4>
                <input type="text" name="pp_cs" class="form-control bg-dark text-light" value="jijdjkdkdk">
            </div>
            <hr>
            <h4 class="text-primary"><i class="fa fab-paypal"></i> Paystack:</h4>
            <div class="form-group">
                <h4 class="text-light">Paystack Public Key</h4>
                <input type="text" name="paystack_public_key" class="form-control bg-dark text-light" value="">
            </div>
            <div class="form-group">
                <h4 class="text-light">Paystack Secret Key</h4>
                <input type="text" name="paystack_secret_key" class="form-control bg-dark text-light" value="">
            </div>
            <div class="form-group">
                <h4 class="text-light">Paystack URL</h4>
                <input type="text" name="paystack_url" class="form-control bg-dark text-light" value="https://api.paystack.co" readonly>
            </div>
            <div class="form-group">
                <h4 class="text-light">Paystack Email</h4>
                <input type="text" name="paystack_email" class="form-control bg-dark text-light" value="victrinhoj@gmail.com">
            </div>
            <div class="form-group col-md-6">
