					...
					<tr class="proton-tr">
						<td class="proton-td" colspan="10" style="">
							...
							<center>
								...
								<img src="{{asset('logo1.png')}}" alt="Image" />
							</center>
							
                                  <br>
							<center>
                                        <p>
                                       Great News! your account verification is now complete. You can login to your dashboard to explore our extensive investment and trading options, gain access to valauable market insights, and leverage our expert advantages to inform your investment decisions.              
                                        </p>
										<br>
