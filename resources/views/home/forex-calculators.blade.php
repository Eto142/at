        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <p class="lead-3">Forex trading calculators – Calculate current pip values in your account currency across IC Markets Global range of products.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="btn-flex">
                        <a id="forex_calculators_1" class="btn btn-primary me-3" href="../open-trading-account/live.html">Open Trading Account</a>
                        <a id="forex_calculators_2" class="btn btn-outline-primary" href="../open-trading-account/demo.html">Try  a free demo</a>
                    </div>
                </div>
            </div>
        </div>
