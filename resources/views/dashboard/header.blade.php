...
<head>
    ...
    <title>Home</title>
    <link rel="icon" type="image/x-icon" href="storage/generalconfig/small_app_logo1690844352.png"/>
    <!-- ENABLE LOADERS -->
 ...
 <div class="header-container">
    ...
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <div class="d-flex">
                      ...
                      <img id="profile-img" style="width:180px;" class="profile-img-card" src="assets/images/logo.png" />  </b>
        </div>
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                                                            <img src=storage/default.jpg" class="img-fluid me-2">
...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <ul class="collapse submenu list-unstyled " id="FnProducts" data-bs-parent="#accordionExample">
                ...
                <li class="menu ">
                    <a href="{{url('trade')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trello"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="7" width="3" height="9"></rect><rect x="14" y="7" width="3" height="5"></rect></svg>
                            <span>Trade</span>
                        </div>
                ...
                <li class="menu ">
                    <a href="{{url('escrow-account')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trello"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="7" width="3" height="9"></rect><rect x="14" y="7" width="3" height="5"></rect></svg>
...
<script>
    ...
    // Get the components of the date in the user's local timezone
    ...
    var offsetHours = Math.floor(date.getTimezoneOffset() / 60);
    var offsetMinutes = Math.abs(date.getTimezoneOffset() % 60);
    var offsetSign = date.getTimezoneOffset() > 0 ? '-' : '+';

    // Construct the final string with the local date and time
    var formattedDate = day + '-' + month + '-' + year + ' ' + hours + ':' + minutes + ' GMT' + offsetSign + offsetHours + ':' + (offsetMinutes < 10 ? '0' + offsetMinutes : offsetMinutes);
