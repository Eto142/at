...
<head>
    ...
    <title>Pinnacleassetstrd| User Dashboard</title>
    <link rel="icon" href="{{asset('user/account/storage/app/public/photos/uPYDzhfavicon.png1677339254')}}" type="image/png"/>
        ...
        <div class="container-fluid">
            <div class="collapse" id="search-nav">
                ...
                <script>
                   ...
                   function searchuser(){
                       console.log('ddj');
                       let url = "https://altruisticmarkets.com/account/admin/dashboard/manageusers";
...
<script type="text/javascript">
    //create investment
        ...
        $.ajax({
            url: "https://altruisticmarkets.com/account/admin/dashboard/changestyle",
            type: 'POST',
        ...
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item   ">
                   ...
                   <li class="nav-item ">
                    <a href="{{route('all-purchased')}}">
                        <i class="fas fa-cubes " aria-hidden="true"></i>
                        <p>Purchased Account</p>
                    </a>
                </li>
                ...
                <li class="nav-item          ">
                    ...
                    <div class="collapse" id="settings">
                        <ul class="nav nav-collapse">
                            ...
                            <!--<li>-->
                            <!--    <a href="{{route('referral.settings')}}">-->
                            ...
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{route('exchange.settings')}}">-->
                            ...
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{route('terms.settings')}}">-->
                            <!--        <span class="sub-item">Terms and Privacy</span>-->
                            <!--    </a>-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <a href="{{route('ip.settings')}}">-->
             ...
             <!--   <li class="nav-item ">
                    <a href="https://altruisticmarkets.com/account/admin/dashboard/about">
